...
- **The Producer (PopulateTemplateServiceImpl):**
...
- **The Queue (report_generation_task table):**
...
- **3The Consumer (ReportTaskProcessorService):**
...
- **External Message Broker (e.g., RabbitMQ, Kafka)**
